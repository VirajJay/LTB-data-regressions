...
if __name__=="__main__":
    ...
    #initialise the array to read in data
    data=[]
    ...
    ref_val_2=data[1][25]
    output=[]
    #iterate through all data points and get the daily energy generated by each panel
    ...
    #write the output into a string and send it to a csv file on the harddrive
